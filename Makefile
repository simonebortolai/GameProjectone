main: main.o printer.o misc.o entity.o livingentity.o miscFunc.o bullet.o room.o
	g++ -o main main.o printer.o misc.o entity.o livingentity.o miscFunc.o room.o bullet.o -lcurses
	rm *.o
